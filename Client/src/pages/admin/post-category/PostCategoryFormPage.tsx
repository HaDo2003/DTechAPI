...
const PostCategoryFormPage: React.FC = () => {
    ...
    const [form, setForm] = useState<PostCategoryForm>({
        id: 0,
        name: "",
        slug: "",
    });
    ...
    return (
        <>
            ...
            <CardWrapped title="Post Category Form">
                <form onSubmit={handleSubmit}>
                    <div className="card">
                        <div className="card-header text-center">
                            <h3>{mode === "create" ? "Create Post Category" : "Edit Post Category"}</h3>
                        </div>
...
export default PostCategoryFormPage;
